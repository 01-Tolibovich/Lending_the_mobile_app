<template>
    <section class="custom-bg p-4 mt-20">
        <div class="mx-auto grid md:grid-cols-4 grid-cols-1 grid-rows-1 max-w-4xl ">
          ...
          <div class="bg-white">
            <div class="relative  h-28 bg-slate-800">
              ...
              <div class=" text-white text-center py-4">
                <h2 class="text-lg font-bold my-2">СТАНДАРТ</h2>
                <h3 class="text-xl font-light">3,99 USD</h3>
              </div>
            </div>
            <div class=" text-lg uppercase">
